...
<table width="100%">
    <tr>
        <td class="titleline" width="100%"><font class="head" size="-1">Itherian Calculator</font></td>
    </tr>
</table>
...
<table width="100%">
    <tr>
        <td class="titleline" width="100%"><font class="head" size="-1">Sacs</font></td>
    </tr>
</table>
...
<table width="100%">
    <tr>
        <td class="titleline" width="100%"><font class="head" size="-1">Itherian</font></td>
    </tr>
</table>
...
<tr><td>
	...
	<% HashMap<String,Integer> ithItems = (HashMap<String,Integer>)request.getAttribute("itherian_items"); 
